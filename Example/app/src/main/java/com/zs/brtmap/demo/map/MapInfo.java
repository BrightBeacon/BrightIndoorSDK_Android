...
public class MapInfo extends BaseMapViewActivity {
    ...
    public void initContentViewID() {
        contentViewID = R.layout.activity_map_info;
    }
    ...
    @Override
    public void mapViewDidZoomed(final TYMapView mapView) {
        super.mapViewDidZoomed(mapView);runOnUiThread(new Runnable() {
            @Override
            public void run() {
